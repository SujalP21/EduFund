    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">EduFund</h3>
            <p className="text-gray-300">
              Bridging the education gap with crowdfunded scholarships. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/register" className="text-gray-300 hover:text-white">Join Us</Link></li>
            </ul>
          </div>
          <div>
